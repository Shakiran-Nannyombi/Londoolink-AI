...
from app.services.rag.embeddings import ChromaEmbeddingFunction, EmbeddingManager
...
class TestTextChunker:
    ...
    def test_chunk_text_large(self):
        ...
        text = (
            "This is a very long text that needs to be chunked into smaller pieces. "
            * 10
        )
...
class TestRAGPipeline:
    ...
    def test_query_texts_with_filter(self, mock_chromadb, mock_ollama_embeddings):
        ...
        results = pipeline.query_texts(
            query, n_results=3, filter_metadata=filter_metadata
        )
    ...
    def test_search_by_content_type_no_query(
        self, mock_chromadb, mock_ollama_embeddings
    ):
