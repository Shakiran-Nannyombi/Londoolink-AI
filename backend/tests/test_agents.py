...
class TestAICoordinator:
    ...
    def test_coordinator_init(
        self, mock_priority, mock_social, mock_calendar, mock_email, mock_tools
    ):
    ...
    @patch("app.services.coordinator.SocialAgent")
    @patch("app.services.coordinator.PriorityAgent")
    def test_coordinator_get_daily_briefing(
        self, mock_priority, mock_social, mock_calendar, mock_email, mock_tools
    ):
    ...
    @patch("app.services.coordinator.SocialAgent")
    @patch("app.services.coordinator.PriorityAgent")
    def test_coordinator_analyze_document_email(
        self, mock_priority, mock_social, mock_calendar, mock_email, mock_tools
    ):
    ...
    @patch("app.services.coordinator.SocialAgent")
    @patch("app.services.coordinator.PriorityAgent")
    def test_coordinator_analyze_document_social(
        self, mock_priority, mock_social, mock_calendar, mock_email, mock_tools
    ):
        ...
        assert isinstance(result, dict)
        assert result["agent_type"] == "social"
        mock_social_instance.analyze_message.assert_called_once_with(
    ...
    @patch("app.services.coordinator.SocialAgent")
    @patch("app.services.coordinator.PriorityAgent")
    def test_coordinator_analyze_document_general(
        self, mock_priority, mock_social, mock_calendar, mock_email, mock_tools
    ):
        ...
        assert isinstance(result, dict)
        assert result["agent_type"] == "priority"
        mock_priority_instance.analyze_document.assert_called_once_with(
            content, document_type
        )
