...
from app.services.agents import EmailAgent, CalendarAgent, SocialAgent, PriorityAgent
    ...
    def analyze_document(self, content: str, document_type: str) -> Dict[str, Any]:
        ...
        try:
            if document_type == 'email':
                ...
                return self.calendar_agent.analyze(f"Analyze this calendar event for importance and scheduling considerations:\n\n{content}")
